# openAPI schema part7 for dataproc.cnrm.cloud.google.com.v1beta1.DataprocWorkflowTemplate
          ...
          managedCluster:
            properties:
              config:
                properties:
                  securityConfig:
                    properties:
                      securityConfig:
                        description: Immutable. Optional. Security settings for the
                          cluster.
                        properties:
                          kerberosConfig:
                            ...
                            properties:
                              crossRealmTrustAdminServer:
                                description: Immutable. Optional. The admin server
                                  (IP or hostname) for the remote trusted realm in
                              ...
                              crossRealmTrustRealm:
                                description: Immutable. Optional. The remote realm
                                  the Dataproc on-cluster KDC will trust, should the
                              ...
                              crossRealmTrustSharedPassword:
                                description: Immutable. Optional. The Cloud Storage
                                  ...
                                  password between the on-cluster Kerberos realm and
                              ...
                              keyPassword:
                                description: Immutable. Optional. The Cloud Storage
                                  ...
                                  to the user provided key. For the self-signed certificate,
                              ...
                              kmsKeyRef:
                                ...
                                type: object
                              realm:
                                description: Immutable. Optional. The name of the
                                  on-cluster Kerberos realm. If not specified, the
                              ...
                              rootPrincipalPassword:
                                ...
                                type: string
                              tgtLifetimeHours:
                                description: Immutable. Optional. The lifetime of
                                  the ticket granting ticket, in hours. If not specified,
              ...
              labels:
                additionalProperties:
                  type: string
                description: 'Immutable. Optional. The labels to associate with this
                  cluster. Label keys must be between 1 and 63 characters long, and
                  must conform to the following PCRE regular expression: p{Ll}p{Lo}{0,62}
