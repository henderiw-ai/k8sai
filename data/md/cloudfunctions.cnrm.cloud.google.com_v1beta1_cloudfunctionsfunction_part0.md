# openAPI schema part0 for cloudfunctions.cnrm.cloud.google.com.v1beta1.CloudFunctionsFunction
  ...
  spec:
    properties:
      ...
      environmentVariables:
        ...
        type: object
      eventTrigger:
        description: Immutable. A source that fires events in response to a condition
          in another service.
        properties:
          eventType:
            description: |-
        ...
        type: object
      httpsTrigger:
        description: Immutable. An HTTPS endpoint type of source that can be triggered
          via URL.
        properties:
          securityLevel:
            description: 'Immutable. Both HTTP and HTTPS requests with URLs that match
      ...
      serviceAccountRef:
        ...
        type: object
      sourceArchiveUrl:
        description: Immutable. The Google Cloud Storage URL, starting with gs://,
  ...
  status:
    properties:
      ...
      status:
        ...
        type: string
      updateTime:
        description: Output only. The last update timestamp of a Cloud Function in
