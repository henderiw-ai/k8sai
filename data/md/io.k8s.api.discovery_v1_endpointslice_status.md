# openAPI schema status for io.k8s.api.discovery.v1.EndpointSlice
...
|
  ...
  properties:
    ...
    apiVersion:
      ...
      type: string
    endpoints:
      description: endpoints is a list of unique endpoints in this slice. Each slice
    ...
    ports:
      description: ports specifies the list of network ports exposed by each endpoint
        in this slice. Each port must have a unique name. When ports is empty, it indicates
