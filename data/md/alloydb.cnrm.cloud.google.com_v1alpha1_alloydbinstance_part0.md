# openAPI schema part0 for alloydb.cnrm.cloud.google.com.v1alpha1.AlloyDBInstance
    ...
    properties:
      annotations:
        additionalProperties:
          type: string
        description: Annotations to allow client tools to store small amount of arbitrary
      ...
      databaseFlags:
        additionalProperties:
          type: string
        description: Database flags. Set at instance level. * They are copied from
          primary instance on read instance creation. * Read instances can set new
          or override existing flags that are relevant for reads, e.g. for enabling
      ...
      displayName:
        ...
        type: string
      gceZone:
        description: The Compute Engine zone that the instance should serve from,
          per https://cloud.google.com/compute/docs/regions-zones This can ONLY be
        ...
        type: string
      instanceType:
        description: 'Immutable. The type of the instance. If the instance type is
          READ_POOL, provide the associated PRIMARY instance in the ''depends_on''
          meta-data attribute. Possible values: ["PRIMARY", "READ_POOL"].'
        type: string
      machineConfig:
        description: Configurations for the machines that host the underlying database
          engine.
        properties:
          cpuCount:
      ...
      readPoolConfig:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The instanceId of the resource. Used for
  ...
  status:
    properties:
      ...
      createTime:
        ...
        type: string
      ipAddress:
        description: The IP address for the Instance. This is the connection endpoint
      ...
      observedGeneration:
        ...
        type: integer
      reconciling:
        description: Set to true if the current state of Instance does not match the
