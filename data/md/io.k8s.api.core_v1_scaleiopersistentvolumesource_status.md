# openAPI schema status for io.k8s.api.core.v1.ScaleIOPersistentVolumeSource
  ...
  properties:
    fsType:
      description: fsType is the filesystem type to mount. Must be a filesystem type
        supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Default is
        "xfs"
      type: string
    gateway:
    ...
    sslEnabled:
      description: sslEnabled is the flag to enable/disable SSL communication with Gateway,
        default false
      type: boolean
    storageMode:
