# openAPI schema part0 for dialogflowcx.cnrm.cloud.google.com.v1alpha1.DialogflowCXIntent
    ...
    properties:
      description:
        description: 'Human readable description for better understanding an intent
          like its scope, content, result etc. Maximum character limit: 140 characters.'
        type: string
      displayName:
        ...
        items:
          properties:
            entityType:
              ...
              type: string
            id:
              description: The unique identifier of the parameter. This field is used
      ...
      resourceID:
        ...
        type: string
      trainingPhrases:
        description: The collection of training phrases the agent is trained on to
          identify the intent.
        items:
          properties:
            id:
            ...
            parts:
              ...
              items:
                properties:
                  parameterId:
                    description: The parameter used to annotate this part of the training
              ...
              type: array
            repeatCount:
              description: Indicates how many times this example was added to the
                intent.
              type: integer
          required:
          - parts
