# openAPI schema part0 for kms.cnrm.cloud.google.com.v1alpha1.KMSSecretCiphertext
...
properties:
  ...
  spec:
    properties:
      additionalAuthenticatedData:
        description: Immutable. The additional authenticated data used for integrity
          checks during encryption and decryption.
        oneOf:
        - not:
            required:
            - valueFrom
      ...
      plaintext:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The service-generated ciphertext of the
          resource. Used for acquisition only. Leave unset to create a new resource.
        type: string
    required:
    - cryptoKey
    - plaintext
  ...
  status:
    properties:
      ciphertext:
        description: Contains the result of encrypting the provided plaintext, encoded
          in base64.
        type: string
      conditions:
