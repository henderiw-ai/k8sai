# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeNodeGroup
  ...
  spec:
    properties:
      ...
      description:
        ...
        type: string
      initialSize:
        description: Immutable. The initial number of nodes in the node group. One
          of 'initial_size' or 'size' must be specified.
        type: integer
      maintenancePolicy:
        description: 'Immutable. Specifies how to handle instances when a node in
      ...
      maintenanceWindow:
        ...
        properties:
          startTime:
            description: Immutable. instances.start time of the window. This must
              be in UTC format that resolves to one of 00:00, 04:00, 08:00, 12:00,
      ...
      shareSettings:
        ...
        properties:
          projectMap:
            description: Immutable. A map of project id and project config. This is
              only valid when shareType's value is SPECIFIC_PROJECTS.
            items:
              properties:
                idRef:
            ...
            type: array
          shareType:
            description: 'Immutable. Node group sharing type. Possible values: ["ORGANIZATION",
        ...
        type: object
      size:
        description: Immutable. The total number of nodes in the node group. One of
          'initial_size' or 'size' must be specified.
        type: integer
      zone:
