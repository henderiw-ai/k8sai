# openAPI schema part0 for networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesMesh
    ...
    properties:
      ...
      interceptionPort:
        description: Optional. If set to a valid TCP port (1-65535), instructs the
          SIDECAR proxy to listen on the specified port of localhost (127.0.0.1) address.
          ...
          used as the interception port. This field is only valid if the type of Mesh
          is SIDECAR.
        format: int64
        type: integer
      location:
