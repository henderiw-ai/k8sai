# openAPI schema part0 for recaptchaenterprise.cnrm.cloud.google.com.v1beta1.RecaptchaEnterpriseKey
  ...
  spec:
    properties:
      androidSettings:
        ...
        properties:
          allowAllPackageNames:
            description: If set to true, it means allowed_package_names will not be
              enforced.
            type: boolean
          allowedPackageNames:
            description: 'Android package names of apps allowed to use the key. Example:
      ...
      testingOptions:
        ...
        properties:
          testingChallenge:
            description: 'Immutable. For challenge-based keys only (CHECKBOX, INVISIBLE),
            ...
            type: string
          testingScore:
            description: Immutable. All assessments for this Key will return this
      ...
      webSettings:
        ...
        properties:
          allowAllDomains:
            ...
            type: boolean
          allowAmpTraffic:
            description: If set to true, the key can be used on AMP (Accelerated Mobile
          ...
          challengeSecurityPreference:
            description: 'Settings for the frequency and difficulty at which this
              key triggers captcha challenges. This should only be specified for IntegrationTypes
              CHECKBOX and INVISIBLE. Possible values: CHALLENGE_SECURITY_PREFERENCE_UNSPECIFIED,
