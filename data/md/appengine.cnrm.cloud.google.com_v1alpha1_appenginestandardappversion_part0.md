# openAPI schema part0 for appengine.cnrm.cloud.google.com.v1alpha1.AppEngineStandardAppVersion
...
properties:
  ...
  spec:
    properties:
      appEngineApis:
        description: Allows App Engine second generation runtimes to access the legacy
          bundled services.
        type: boolean
      automaticScaling:
            ...
            properties:
              ...
              targetCpuUtilization:
                description: Target CPU utilization ratio to maintain when scaling.
                  Should be a value in the range [0.50, 0.95], zero, or a negative
                  value.
                type: number
              targetThroughputUtilization:
                description: Target throughput utilization ratio to maintain when
                  scaling. Should be a value in the range [0.50, 0.95], zero, or a
                  negative value.
                type: number
            type: object
        type: object
      basicScaling:
        description: Basic scaling creates instances when your application receives
          requests. Each instance will be shut down when the application becomes idle.
          Basic scaling is ideal for work that is intermittent or driven by user activity.
        properties:
          idleTimeout:
            description: |-
            ...
            type: string
          maxInstances:
            description: Maximum number of instances to create for this version. Must
              be in the range [1.0, 200.0].
            type: integer
        required:
        - maxInstances
        type: object
        ...
        items:
          properties:
            ...
            securityLevel:
              ...
              type: string
            staticFiles:
              description: Files served directly to the user for a given URL, such
                as images, CSS stylesheets, or JavaScript source files. Static file
                handlers describe which files in the application directory are static
      ...
      instanceClass:
        ...
        type: string
      libraries:
        description: Configuration for third-party Python runtime libraries that are
      ...
      runtimeApiVersion:
        ...
        type: string
      serviceAccount:
        description: The identity that the deployed version will run as. Admin API
          will use the App Engine Appspot service account as default if this field
      ...
      serviceRef:
        ...
        type: object
      threadsafe:
        description: Whether multiple requests can be dispatched to this version at
          once.
        type: boolean
      vpcAccessConnector:
        ...
        properties:
          egressSetting:
            description: The egress setting for the connector, controlling what traffic
