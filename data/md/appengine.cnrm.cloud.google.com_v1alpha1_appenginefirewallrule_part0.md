# openAPI schema part0 for appengine.cnrm.cloud.google.com.v1alpha1.AppEngineFirewallRule
...
properties:
  ...
  spec:
    properties:
      action:
        description: 'The action to take if this rule matches. Possible values: ["UNSPECIFIED_ACTION",
          "ALLOW", "DENY"].'
        type: string
      description:
