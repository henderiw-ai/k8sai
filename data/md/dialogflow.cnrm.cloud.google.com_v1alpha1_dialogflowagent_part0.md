# openAPI schema part0 for dialogflow.cnrm.cloud.google.com.v1alpha1.DialogflowAgent
  ...
  spec:
    properties:
      ...
      matchMode:
        ...
        type: string
      resourceID:
        description: Immutable. Optional. The project of the resource. Used for creation
