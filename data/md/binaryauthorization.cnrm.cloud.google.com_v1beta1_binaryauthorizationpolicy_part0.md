# openAPI schema part0 for binaryauthorization.cnrm.cloud.google.com.v1beta1.BinaryAuthorizationPolicy
    ...
    properties:
      admissionWhitelistPatterns:
        description: Optional. Admission policy allowlisting. A matching admission
          ...
          Google or third-party infrastructure images from Binary Authorization policies.
        items:
          properties:
            namePattern:
              description: An image name pattern to allowlist, in the form `registry/path/to/image`.
                ...
                in text after the `registry/` part.
              type: string
          type: object
        type: array
                ...
                properties:
                  external:
                    description: 'Allowed value: The Google Cloud resource name of
                      a `BinaryAuthorizationAttestor` resource (format: `projects/{{project}}/attestors/{{name}}`).'
                    type: string
                  name:
              ...
              properties:
                external:
                  description: 'Allowed value: The Google Cloud resource name of a
                    `BinaryAuthorizationAttestor` resource (format: `projects/{{project}}/attestors/{{name}}`).'
                  type: string
                name:
                  description: 'Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names'
                  type: string
      ...
      globalPolicyEvaluationMode:
        description: 'Optional. Controls the evaluation of a Google-maintained global
          ...
          global policy will be subject to the project admission policy. This setting
          has no effect when specified inside a global admission policy. Possible
