# openAPI schema part0 for apigee.cnrm.cloud.google.com.v1alpha1.ApigeeEndpointAttachment
  ...
  spec:
    properties:
      ...
      orgId:
        ...
        type: string
      resourceID:
        description: Immutable. Optional. The endpointAttachmentId of the resource.
  ...
  status:
    properties:
      ...
      connectionState:
        ...
        type: string
      host:
        description: Host that can be used in either HTTP Target Endpoint directly,
