# openAPI schema part0 for bigtable.cnrm.cloud.google.com.v1beta1.BigtableAppProfile
  ...
  spec:
    properties:
      ...
      multiClusterRoutingClusterIds:
        description: The set of clusters to route to. The order is ignored; clusters
          will be tried in order of distance. If left empty, all clusters are eligible.
        items:
          type: string
        type: array
      multiClusterRoutingUseAny:
        ...
        type: boolean
      resourceID:
        description: Immutable. Optional. The appProfileId of the resource. Used for
