# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeRegionNetworkEndpointGroup
  ...
  spec:
    properties:
      ...
      description:
        ...
        type: string
      networkEndpointType:
        description: 'Immutable. Type of network endpoints in this network endpoint
          group. Defaults to SERVERLESS Default value: "SERVERLESS" Possible values:
      ...
      pscTargetService:
        ...
        type: string
      region:
        description: Immutable. A reference to the region where the Serverless NEGs
          Reside.
        type: string
      resourceID:
