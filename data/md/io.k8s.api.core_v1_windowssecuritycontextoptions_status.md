# openAPI schema status for io.k8s.api.core.v1.WindowsSecurityContextOptions
...
|
  ...
  properties:
    ...
    gmsaCredentialSpecName:
      ...
      type: string
    hostProcess:
      description: HostProcess determines if a container should be run as a 'Host Process'
    ...
    runAsUserName:
      description: The UserName in Windows to run the entrypoint of the container process.
        ...
        set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext,
