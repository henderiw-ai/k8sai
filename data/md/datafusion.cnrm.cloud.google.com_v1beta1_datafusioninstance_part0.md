# openAPI schema part0 for datafusion.cnrm.cloud.google.com.v1beta1.DataFusionInstance
  ...
  spec:
    properties:
      ...
      networkConfig:
        ...
        properties:
          ipAllocation:
            description: Immutable. The IP range in CIDR notation to use for the managed
      ...
      options:
        additionalProperties:
          type: string
        description: Immutable. Map of additional options used to configure the behavior
          of Data Fusion instance.
        type: object
      privateInstance:
        description: Immutable. Specifies whether the Data Fusion instance should
          be private. If set to true, all Data Fusion nodes will have private IP addresses
          and will not be able to access the public internet.
        type: boolean
      resourceID:
        ...
        type: string
      type:
        description: 'Immutable. Required. Instance type. Possible values: TYPE_UNSPECIFIED,
      ...
      version:
        ...
        type: string
      zone:
        description: Immutable. Name of the zone in which the Data Fusion instance
          will be created. Only DEVELOPER instances use this field.
        type: string
    required:
    - location
    - type
  ...
  status:
    properties:
        ...
        items:
          properties:
            ...
            defaultVersion:
              ...
              type: boolean
            versionNumber:
              description: The version number of the Data Fusion instance, such as
                '6.0.1.0'.
              type: string
          type: object
        type: array
      ...
      createTime:
        ...
        type: string
      gcsBucket:
        description: Output only. Cloud Storage bucket generated by Data Fusion in
      ...
      state:
        ...
        type: string
      stateMessage:
        description: Output only. Additional information about the current state of
