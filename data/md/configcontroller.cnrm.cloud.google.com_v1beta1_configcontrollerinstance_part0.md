# openAPI schema part0 for configcontroller.cnrm.cloud.google.com.v1beta1.ConfigControllerInstance
  ...
  spec:
    properties:
      ...
      managementConfig:
        ...
        properties:
          fullManagementConfig:
            description: Immutable. Configuration of the full (Autopilot) cluster
              management
            properties:
              clusterCidrBlock:
                ...
                type: string
              clusterNamedRange:
                description: Immutable. The name of the existing secondary range in
                ...
                type: string
              manBlock:
                description: Immutable. Master Authorized Network. Allows access to
                  the k8s master from this block.
                type: string
              masterIPv4CidrBlock:
              ...
              networkRef:
                ...
                type: object
              servicesCidrBlock:
                description: Immutable. The IP address range for the cluster service
      ...
      resourceID:
        ...
        type: string
      usePrivateEndpoint:
        description: Immutable. Only allow access to the master's private endpoint
          IP.
        type: boolean
    required:
    - location
  ...
  status:
    properties:
      conditions:
        ...
        type: array
      gkeResourceLink:
        description: Output only. KrmApiHost GCP self link used for identifying the
          underlying endpoint (GKE cluster currently).
        type: string
      observedGeneration:
