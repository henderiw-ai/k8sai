# openAPI schema part0 for identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformTenantInboundSAMLConfig
  ...
  spec:
    properties:
      ...
      idpConfig:
        ...
        properties:
          idpCertificates:
            description: The IDP's certificate data to verify the signature in the
      ...
      spConfig:
        ...
        properties:
          callbackUri:
            description: Callback URI where responses from IDP are handled. Must start
              with 'https://'.
            type: string
          spCertificates:
            description: The IDP's certificate data to verify the signature in the
        ...
        type: object
      tenant:
        description: Immutable. The name of the tenant where this inbound SAML config
          resource exists.
        type: string
    required:
    - displayName
