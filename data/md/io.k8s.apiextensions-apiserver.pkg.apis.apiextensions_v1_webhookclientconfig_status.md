# openAPI schema status for io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.WebhookClientConfig
  ...
  properties:
    caBundle:
      description: caBundle is a PEM encoded CA bundle which will be used to validate
        the webhook's server certificate. If unspecified, system trust roots on the
        apiserver are used.
      format: byte
      type: string
    service:
