# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeSharedVPCServiceProject
...
properties:
  ...
  spec:
    properties:
      deletionPolicy:
        description: "The deletion policy for the shared VPC service. Setting ABANDON
          allows the resource\n\t\t\t\tto be abandoned rather than deleted. Possible
          values are: \"ABANDON\"."
        type: string
      projectRef:
        oneOf:
