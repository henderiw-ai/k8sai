# openAPI schema part0 for apigee.cnrm.cloud.google.com.v1alpha1.ApigeeInstance
  ...
  spec:
    properties:
      ...
      ipRange:
        ...
        type: string
      location:
        description: Immutable. Required. Compute Engine location where the instance
          resides.
        type: string
      orgId:
        description: |-
  ...
  status:
    properties:
      conditions:
        ...
        type: array
      host:
        description: Output only. Hostname or IP address of the exposed Apigee endpoint
