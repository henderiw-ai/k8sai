# openAPI schema part0 for vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIMetadataStore
...
properties:
  ...
  spec:
    properties:
      description:
        description: Immutable. Description of the MetadataStore.
        type: string
      encryptionSpec:
        description: Immutable. Customer-managed encryption key spec for a MetadataStore.
          If set, this MetadataStore and all sub-resources of this MetadataStore will
  ...
  status:
    properties:
      conditions:
        ...
        type: array
      createTime:
        description: The timestamp of when the MetadataStore was created in RFC3339
      ...
      state:
        ...
        type: array
      updateTime:
        description: The timestamp of when the MetadataStore was last updated in RFC3339
          UTC "Zulu" format, with nanosecond resolution and up to nine fractional
          digits.
        type: string
    type: object
