# openAPI schema part0 for tags.cnrm.cloud.google.com.v1beta1.TagsTagValue
...
properties:
  ...
  spec:
    properties:
      description:
        description: User-assigned description of the TagValue. Must not exceed 256
          characters.
        type: string
      parentRef:
        oneOf:
  ...
  status:
    properties:
      ...
      name:
        ...
        type: string
      namespacedName:
        description: Output only. Namespaced name of the TagValue. Will be in the
