# openAPI schema status for io.k8s.api.batch.v1.CronJobSpec
...
|
  ...
  properties:
    ...
    successfulJobsHistoryLimit:
      description: The number of successful finished jobs to retain. Value must be non-negative
    ...
    timeZone:
      description: The time zone name for the given schedule, see https://en.wikipedia.org/wiki/List_of_tz_database_time_zones.
        ...
        in host configuration, the controller will stop creating new new Jobs and will
        create a system event with the reason UnknownTimeZone. More information can
