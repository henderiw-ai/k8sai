# openAPI schema part0 for appengine.cnrm.cloud.google.com.v1alpha1.AppEngineDomainMapping
  ...
  spec:
    properties:
      ...
      project:
        ...
        type: string
      resourceID:
        description: Immutable. Optional. The domainName of the resource. Used for
