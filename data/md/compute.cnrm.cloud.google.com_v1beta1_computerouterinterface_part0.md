# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeRouterInterface
  ...
  spec:
    properties:
      interconnectAttachmentRef:
        ...
        type: object
      ipRange:
        description: Immutable. The IP address and range of the interface. The IP
          range must be in the RFC3927 link-local IP space. Changing this forces a
      ...
      redundantInterfaceRef:
        ...
        type: object
      region:
        description: Immutable. The region this interface's router sits in. If not
          specified, the project region will be used. Changing this forces a new interface
          to be created.
        type: string
      resourceID:
