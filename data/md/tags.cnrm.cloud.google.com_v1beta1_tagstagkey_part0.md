# openAPI schema part0 for tags.cnrm.cloud.google.com.v1beta1.TagsTagKey
...
properties:
  ...
  spec:
    properties:
      description:
        description: User-assigned description of the TagKey. Must not exceed 256
          characters.
        type: string
      parent:
        description: Immutable. Input only. The resource name of the new TagKey's
          parent. Must be of the form organizations/{org_id} or projects/{project_id_or_number}.
        type: string
      purpose:
        description: |-
