# openAPI schema part0 for datastream.cnrm.cloud.google.com.v1alpha1.DatastreamPrivateConnection
...
properties:
  ...
  spec:
    properties:
      displayName:
        description: Immutable. Display name.
        type: string
      location:
        description: Immutable. The name of the location this private connection is
          located in.
        type: string
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The privateConnectionId of the resource.
        ...
        items:
          properties:
            details:
              ...
              type: object
            message:
              description: A message containing more information about the error that
                occurred.
              type: string
          type: object
        type: array
