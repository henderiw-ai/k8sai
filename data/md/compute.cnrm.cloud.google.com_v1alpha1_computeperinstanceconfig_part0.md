# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputePerInstanceConfig
  ...
  spec:
    properties:
      instanceGroupManagerRef:
        ...
        properties:
          external:
            description: 'Allowed value: The `name` field of a `ComputeInstanceGroupManager`
              resource.'
            type: string
          name:
      ...
      resourceID:
        ...
        type: string
      zone:
        description: Immutable. Zone where the containing instance group manager is
          located.
        type: string
    required:
    - instanceGroupManagerRef
