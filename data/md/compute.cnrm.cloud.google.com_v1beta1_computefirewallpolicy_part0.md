# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeFirewallPolicy
    ...
    properties:
      ...
      folderRef:
        description: Immutable. The Folder that this resource belongs to. Only one
          of [folderRef, organizationRef] may be specified.
        oneOf:
        - not:
            required:
            - external
      ...
      organizationRef:
        description: Immutable. The Organization that this resource belongs to. Only
          one of [folderRef, organizationRef] may be specified.
        oneOf:
        - not:
            required:
            - external
      ...
      resourceID:
        ...
        type: string
      shortName:
        description: Immutable. User-provided name of the Organization firewall policy.
  ...
  status:
    properties:
      ...
      creationTimestamp:
        ...
        type: string
      fingerprint:
        description: Fingerprint of the resource. This field is used internally during
      ...
      observedGeneration:
        ...
        type: integer
      ruleTupleCount:
        description: Total count of all firewall policy rule tuples. A firewall policy
