# openAPI schema part0 for dns.cnrm.cloud.google.com.v1beta1.DNSRecordSet
  ...
  spec:
    ...
    properties:
      ...
      name:
        ...
        type: string
      rrdatas:
        description: DEPRECATED. Although this field is still available, there is
          limited support. We recommend that you use `spec.rrdatasRefs` instead.
        items:
          type: string
        type: array
      rrdatasRefs:
