# openAPI schema part0 for pubsublite.cnrm.cloud.google.com.v1alpha1.PubSubLiteSubscription
  ...
  spec:
    properties:
        ...
        properties:
          deliveryRequirement:
            description: 'When this subscription should send messages to subscribers
              relative to messages persistence in storage. Possible values: ["DELIVER_IMMEDIATELY",
      ...
      resourceID:
        ...
        type: string
      topic:
        description: Immutable. A reference to a Topic resource.
        type: string
      zone:
