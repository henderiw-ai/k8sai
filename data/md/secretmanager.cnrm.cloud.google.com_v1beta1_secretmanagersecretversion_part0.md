# openAPI schema part0 for secretmanager.cnrm.cloud.google.com.v1beta1.SecretManagerSecretVersion
  ...
  status:
    properties:
      ...
      createTime:
        ...
        type: string
      destroyTime:
        description: The time at which the Secret was destroyed. Only present if state
          is DESTROYED.
        type: string
      name:
        description: |-
