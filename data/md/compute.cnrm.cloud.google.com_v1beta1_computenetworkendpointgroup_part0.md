# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeNetworkEndpointGroup
  ...
  spec:
    properties:
      ...
      resourceID:
        ...
        type: string
      subnetworkRef:
        description: Optional subnetwork to which all network endpoints in the NEG
          belong.
        oneOf:
        - not:
            required:
