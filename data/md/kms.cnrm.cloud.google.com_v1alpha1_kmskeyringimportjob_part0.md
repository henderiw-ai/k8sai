# openAPI schema part0 for kms.cnrm.cloud.google.com.v1alpha1.KMSKeyRingImportJob
...
properties:
  ...
  spec:
    properties:
      importJobId:
        description: Immutable. It must be unique within a KeyRing and match the regular
          expression [a-zA-Z0-9_-]{1,63}.
        type: string
      importMethod:
        description: 'Immutable. The wrapping method to be used for incoming key material.
          Possible values: ["RSA_OAEP_3072_SHA1_AES_256", "RSA_OAEP_4096_SHA1_AES_256"].'
        type: string
      keyRing:
        description: |-
