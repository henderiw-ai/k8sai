# openAPI schema part0 for firebasehosting.cnrm.cloud.google.com.v1alpha1.FirebaseHostingChannel
  ...
  spec:
    properties:
      expireTime:
        ...
        type: string
      resourceID:
        description: Immutable. Optional. The channelId of the resource. Used for
      ...
      retainedReleaseCount:
        ...
        type: integer
      siteId:
        description: Immutable. Required. The ID of the site in which to create this
          channel.
        type: string
      ttl:
        description: |-
