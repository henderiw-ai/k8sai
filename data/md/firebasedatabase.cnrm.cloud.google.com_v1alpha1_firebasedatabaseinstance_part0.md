# openAPI schema part0 for firebasedatabase.cnrm.cloud.google.com.v1alpha1.FirebaseDatabaseInstance
  ...
  status:
    properties:
      ...
      observedGeneration:
        ...
        type: integer
      state:
        description: The current database state. Set desired_state to :DISABLED to
          disable the database and :ACTIVE to reenable the database.
        type: string
    type: object
required:
- spec
