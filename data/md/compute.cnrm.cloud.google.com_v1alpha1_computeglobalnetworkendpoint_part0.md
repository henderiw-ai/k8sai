# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputeGlobalNetworkEndpoint
  ...
  spec:
    properties:
      ...
      globalNetworkEndpointGroup:
        description: Immutable. The global network endpoint group this endpoint is
          part of.
        type: string
      ipAddress:
        description: Immutable. IPv4 address external endpoint.
        type: string
      projectRef:
