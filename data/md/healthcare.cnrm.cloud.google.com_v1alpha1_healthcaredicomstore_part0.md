# openAPI schema part0 for healthcare.cnrm.cloud.google.com.v1alpha1.HealthcareDICOMStore
    ...
    properties:
      ...
      streamConfigs:
        ...
        items:
          properties:
            bigqueryDestination:
              description: BigQueryDestination to include a fully qualified BigQuery
                table URI where DICOM instance metadata will be streamed.
              properties:
                tableUri:
                  description: a fully qualified BigQuery table URI where DICOM instance
                    metadata will be streamed.
                  type: string
              required:
              - tableUri
              type: object
