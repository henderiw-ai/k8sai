# openAPI schema status for io.k8s.apimachinery.pkg.apis.meta.v1.Condition
...
```yaml
|
  description: Condition contains details for one aspect of the current state of this
    API Resource.
  properties:
    lastTransitionTime:
    ...
    reason:
      description: reason contains a programmatic identifier indicating the reason for
        ...
        a guaranteed API. The value should be a CamelCase string. This field may not
        be empty.
      type: string
    status:
