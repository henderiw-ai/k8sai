# openAPI schema part0 for bigquery.cnrm.cloud.google.com.v1alpha1.BigQueryDatasetAccess
...
properties:
  ...
  spec:
    properties:
      dataset:
        description: Immutable. Grants all resources of particular types in a particular
      ...
      domain:
        ...
        type: string
      groupByEmail:
        description: Immutable. An email address of a Google Group to grant access
          to.
        type: string
      iamMember:
        description: |-
      ...
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The routine of the resource. Used for creation
  ...
  status:
    properties:
      apiUpdatedMember:
        description: If true, represents that that the iam_member in the config was
          translated to a different member type by the API, and is stored in state
          as a different member type.
        type: boolean
      conditions:
