# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeExternalVPNGateway
  ...
  spec:
    properties:
      ...
      interface:
        ...
        type: array
      redundancyType:
        description: 'Immutable. Indicates the redundancy type of this external VPN
