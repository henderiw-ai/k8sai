# openAPI schema status for io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta
  ...
  properties:
    ...
    labels:
      ...
      description: 'Map of string keys and values that can be used to organize and categorize
        ...
        services. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels'
      type: object
    managedFields:
    ...
    name:
      description: 'Name must be unique within a namespace. Is required when creating
        ...
        idempotence and configuration definition. Cannot be updated. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names#names'
      type: string
    namespace:
      description: |-
