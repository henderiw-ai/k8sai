# openAPI schema status for io.k8s.api.core.v1.ReplicationController
...
|
  ...
  properties:
    ...
    metadata:
      ...
      description: 'If the Labels of a ReplicationController are empty, they are defaulted
        to be the same as the Pod(s) that the replication controller manages. Standard
    ...
    spec:
      ...
      description: 'Spec defines the specification of the desired behavior of the replication
    ...
    status:
      ...
      description: 'Status is the most recently observed status of the replication controller.
