# openAPI schema part0 for healthcare.cnrm.cloud.google.com.v1alpha1.HealthcareHL7V2Store
  ...
  spec:
    properties:
      dataset:
        ...
        type: string
      notificationConfig:
        description: DEPRECATED. This field has been replaced by notificationConfigs.
      ...
      parserConfig:
        ...
        properties:
          ...
          segmentTerminator:
            ...
            type: string
          version:
            description: 'Immutable. The version of the unschematized parser to be
              used when a custom ''schema'' is not set. Default value: "V1" Possible
              values: ["V1", "V2", "V3"].'
            type: string
        type: object
      resourceID:
