# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputeOrganizationSecurityPolicyRule
  ...
  spec:
    properties:
      ...
      description:
        ...
        type: string
      direction:
        description: 'The direction in which this rule applies. If unspecified an
          INGRESS rule is created. Possible values: ["INGRESS", "EGRESS"].'
        type: string
      enableLogging:
        description: |-
      ...
      match:
        ...
        type: object
      policyId:
        description: Immutable. The ID of the OrganizationSecurityPolicy this rule
          applies to.
        type: string
      preview:
        ...
        type: boolean
      resourceID:
        description: Immutable. Optional. The priority of the resource. Used for creation
