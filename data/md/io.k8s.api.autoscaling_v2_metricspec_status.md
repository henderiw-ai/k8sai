# openAPI schema status for io.k8s.api.autoscaling.v2.MetricSpec
...
```yaml
|
  description: MetricSpec specifies how to scale based on a single metric (only `type`
  ...
  properties:
    ...
    type:
      description: 'type is the type of metric source.  It should be one of "ContainerResource",
