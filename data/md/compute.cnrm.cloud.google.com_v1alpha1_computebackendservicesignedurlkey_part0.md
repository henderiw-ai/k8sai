# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputeBackendServiceSignedURLKey
  ...
  spec:
    properties:
      backendServiceRef:
        ...
        properties:
          external:
            description: 'Allowed value: The `name` field of a `ComputeBackendService`
              resource.'
            type: string
          name:
