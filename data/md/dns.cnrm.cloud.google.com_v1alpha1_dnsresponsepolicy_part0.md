# openAPI schema part0 for dns.cnrm.cloud.google.com.v1alpha1.DNSResponsePolicy
...
properties:
  ...
  spec:
    properties:
      description:
        description: The description of the response policy, such as 'My new response
          policy'.
        type: string
      gkeClusters:
      ...
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The responsePolicyName of the resource.
