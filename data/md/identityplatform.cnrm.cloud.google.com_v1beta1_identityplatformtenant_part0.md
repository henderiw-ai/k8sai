# openAPI schema part0 for identityplatform.cnrm.cloud.google.com.v1beta1.IdentityPlatformTenant
  ...
  spec:
    properties:
      allowPasswordSignup:
        ...
        type: boolean
      disableAuth:
        description: Whether authentication is disabled for the tenant. If true, the
