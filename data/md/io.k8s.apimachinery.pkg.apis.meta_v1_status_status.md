# openAPI schema status for io.k8s.apimachinery.pkg.apis.meta.v1.Status
...
|
  ...
  properties:
    ...
    reason:
      description: A machine-readable description of why this operation is in the "Failure"
        status. If this value is empty there is no information available. A Reason clarifies
