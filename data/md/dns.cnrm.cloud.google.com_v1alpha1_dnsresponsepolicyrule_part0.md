# openAPI schema part0 for dns.cnrm.cloud.google.com.v1alpha1.DNSResponsePolicyRule
  ...
  spec:
    properties:
      behavior:
        ...
        type: string
      dnsName:
        description: The DNS name (wildcard or exact) to apply this rule to. Must
            ...
            items:
              properties:
                ...
                ttl:
                  ...
                  type: integer
                type:
                  description: 'One of valid DNS resource types. Possible values:
      ...
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The ruleName of the resource. Used for creation
