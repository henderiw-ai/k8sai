# openAPI schema part0 for datacatalog.cnrm.cloud.google.com.v1alpha1.DataCatalogEntryGroup
  ...
  spec:
    properties:
      description:
        ...
        type: string
      displayName:
        description: A short name to identify the entry group, for example, "analytics
          data - jan 2011".
        type: string
      entryGroupId:
        description: |-
      ...
      projectRef:
        ...
        type: object
      region:
        description: Immutable. EntryGroup location region.
        type: string
      resourceID:
