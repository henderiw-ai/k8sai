# openAPI schema part0 for serviceusage.cnrm.cloud.google.com.v1alpha1.ServiceUsageConsumerQuotaOverride
    ...
    properties:
      dimensions:
        additionalProperties:
          type: string
        description: Immutable. If this map is nonempty, then this override applies
          only to specific values for dimensions defined in the limit unit.
        type: object
      force:
        description: |-
      ...
      metric:
        ...
        type: string
      overrideValue:
        description: The overriding quota limit value. Can be any nonnegative integer,
