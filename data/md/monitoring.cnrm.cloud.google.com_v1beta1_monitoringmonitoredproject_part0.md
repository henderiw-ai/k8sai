# openAPI schema part0 for monitoring.cnrm.cloud.google.com.v1beta1.MonitoringMonitoredProject
...
properties:
  ...
  spec:
    properties:
      metricsScope:
        description: 'Immutable. Required. The resource name of the existing Metrics
