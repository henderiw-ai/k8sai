# openAPI schema part0 for dataflow.cnrm.cloud.google.com.v1beta1.DataflowJob
  ...
  spec:
    properties:
      ...
      machineType:
        ...
        type: string
      maxWorkers:
        description: Immutable. The number of workers permitted to work on the job.
      ...
      networkRef:
        ...
        type: object
      parameters:
        description: Key/Value pairs to be passed to the Dataflow job (as used in
          the template).
        type: object
      ...
      transformNameMapping:
        ...
        x-kubernetes-preserve-unknown-fields: true
      zone:
        description: Immutable. The zone in which the created job should run. If it
