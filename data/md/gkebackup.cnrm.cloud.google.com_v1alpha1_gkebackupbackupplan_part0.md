# openAPI schema part0 for gkebackup.cnrm.cloud.google.com.v1alpha1.GKEBackupBackupPlan
  ...
  spec:
    properties:
      ...
      backupSchedule:
        ...
        properties:
          cronSchedule:
            ...
            type: string
          paused:
            description: This flag denotes whether automatic Backup creation is paused
              for this BackupPlan.
            type: boolean
        type: object
      cluster:
        description: Immutable. The source cluster from which Backups will be created
          via this BackupPlan.
        type: string
      deactivated:
        description: |-
      ...
      resourceID:
        ...
        type: string
      retentionPolicy:
        description: RetentionPolicy governs lifecycle of Backups created under this
          plan.
        properties:
