# openAPI schema part0 for mlengine.cnrm.cloud.google.com.v1alpha1.MLEngineModel
  ...
  spec:
    properties:
      defaultVersion:
        ...
        properties:
          name:
            description: Immutable. The name specified for the version when it was
              created.
            type: string
        required:
        - name
        type: object
      description:
        description: Immutable. The description specified for the model when it was
          created.
        type: string
      onlinePredictionConsoleLogging:
        description: Immutable. If true, online prediction nodes send stderr and stdout
          streams to Stackdriver Logging.
        type: boolean
      onlinePredictionLogging:
        description: Immutable. If true, online prediction access logs are sent to
          StackDriver Logging.
        type: boolean
      projectRef:
