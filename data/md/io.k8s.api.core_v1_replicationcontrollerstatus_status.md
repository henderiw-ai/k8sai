# openAPI schema status for io.k8s.api.core.v1.ReplicationControllerStatus
...
|
  ...
  properties:
    availableReplicas:
      ...
      type: integer
    conditions:
      description: Represents the latest available observations of a replication controller's
        current state.
      items:
