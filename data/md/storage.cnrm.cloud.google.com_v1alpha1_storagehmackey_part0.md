# openAPI schema part0 for storage.cnrm.cloud.google.com.v1alpha1.StorageHMACKey
  ...
  spec:
    properties:
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The service-generated accessId of the resource.
          Used for acquisition only. Leave unset to create a new resource.
        type: string
      serviceAccountEmail:
        description: Immutable. The email address of the key's associated service
          account.
        type: string
      state:
