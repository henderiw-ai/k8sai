# openAPI schema part0 for dialogflow.cnrm.cloud.google.com.v1alpha1.DialogflowIntent
  ...
  spec:
    properties:
      ...
      projectRef:
        ...
        type: object
      resetContexts:
        description: Indicates whether to delete all contexts in the current session
