# openAPI schema part0 for bigquery.cnrm.cloud.google.com.v1beta1.BigQueryDataset
...
properties:
  ...
  spec:
    properties:
      access:
        description: An array of objects that define dataset access for one or more
          entities.
        items:
          properties:
            dataset:
      ...
      location:
        ...
        type: string
      maxTimeTravelHours:
        description: Defines the time travel window in hours. The value can be from
      ...
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The datasetId of the resource. Used for
