# openAPI schema part0 for logging.cnrm.cloud.google.com.v1beta1.LoggingLogView
    ...
    properties:
      ...
      filter:
        description: 'Filter that restricts which log entries in a bucket are visible
          ...
          - resource type - log id For example: SOURCE("projects/myproject") AND resource.type
