# openAPI schema part0 for sql.cnrm.cloud.google.com.v1beta1.SQLSSLCert
...
properties:
  ...
  spec:
    properties:
      commonName:
        description: Immutable. The common name to be used in the certificate to identify
          the client. Constrained to [a-zA-Z.-_ ]+. Changing this forces a new resource
          to be created.
        type: string
      instanceRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The service-generated sha1Fingerprint of
  ...
  status:
    properties:
      ...
      createTime:
        ...
        type: string
      expirationTime:
        description: The time when the certificate expires in RFC 3339 format, for
