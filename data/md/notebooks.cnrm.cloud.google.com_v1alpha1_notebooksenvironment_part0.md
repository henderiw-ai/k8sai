# openAPI schema part0 for notebooks.cnrm.cloud.google.com.v1alpha1.NotebooksEnvironment
  ...
  spec:
    properties:
      ...
      locationRef:
        ...
        properties:
          external:
            description: 'Allowed value: The `name` field of a `NotebooksLocation`
              resource.'
            type: string
          name:
      ...
      vmImage:
        ...
        properties:
          imageFamily:
            description: Use this VM image family to find the image; the newest image
