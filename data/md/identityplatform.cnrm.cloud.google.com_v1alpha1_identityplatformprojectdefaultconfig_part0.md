# openAPI schema part0 for identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformProjectDefaultConfig
            ...
            items:
              properties:
                algorithm:
                  ...
                  type: string
                memoryCost:
                  description: Memory cost for hash calculation. Used by scrypt and
                    other similar password derivation algorithms. See https://tools.ietf.org/html/rfc7914
                    for explanation of field.
                  type: integer
                rounds:
                  description: How many rounds for hash calculation. Used by scrypt
                    and other similar password derivation algorithms.
                  type: integer
                saltSeparator:
                  description: Non-printable character to be inserted between the
                    salt and plain text password in base64.
                  type: string
                signerKey:
            ...
            properties:
              ...
              testPhoneNumbers:
                additionalProperties:
                  type: string
                description: A map of <test phone number, fake code> that can be used
