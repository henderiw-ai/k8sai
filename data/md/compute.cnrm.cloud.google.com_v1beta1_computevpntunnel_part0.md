# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeVPNTunnel
  ...
  spec:
    properties:
      ...
      peerExternalGatewayInterface:
        description: Immutable. The interface ID of the external VPN gateway to which
      ...
      peerIp:
        ...
        type: string
      region:
        description: Immutable. The region where the tunnel is located. If unset,
      ...
      targetVPNGatewayRef:
        ...
        type: object
      vpnGatewayInterface:
        description: Immutable. The interface ID of the VPN gateway with which this
