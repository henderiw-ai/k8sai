# openAPI schema part0 for dialogflowcx.cnrm.cloud.google.com.v1alpha1.DialogflowCXEntityType
  ...
  spec:
    properties:
      autoExpansionMode:
        ...
        type: string
      displayName:
        description: The human-readable name of the entity type, unique within the
          agent.
        type: string
      ...
      parent:
        ...
        type: string
      redact:
        description: Indicates whether parameters of the entity type should be redacted
          in log. If redaction is enabled, page parameters and intent parameters referring
