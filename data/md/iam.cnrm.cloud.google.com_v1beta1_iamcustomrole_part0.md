# openAPI schema part0 for iam.cnrm.cloud.google.com.v1beta1.IAMCustomRole
  ...
  spec:
    properties:
      description:
        ...
        type: string
      permissions:
        description: The names of the permissions this role grants when bound in an
          IAM policy. At least one permission must be specified.
        items:
          type: string
        type: array
      resourceID:
        description: Immutable. Optional. The roleId of the resource. Used for creation
