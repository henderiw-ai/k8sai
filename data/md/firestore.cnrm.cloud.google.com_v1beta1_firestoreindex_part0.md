# openAPI schema part0 for firestore.cnrm.cloud.google.com.v1beta1.FirestoreIndex
  ...
  spec:
    properties:
      ...
      fields:
        ...
        type: array
      queryScope:
        description: 'Immutable. The scope at which a query is run. Default value:
          "COLLECTION" Possible values: ["COLLECTION", "COLLECTION_GROUP"].'
        type: string
    required:
    - collection
    - fields
