# openAPI schema part0 for servicedirectory.cnrm.cloud.google.com.v1beta1.ServiceDirectoryEndpoint
  ...
  spec:
    properties:
      ...
      port:
        ...
        type: integer
      resourceID:
        description: Immutable. Optional. The endpointId of the resource. Used for
