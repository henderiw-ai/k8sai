# openAPI schema part0 for certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerCertificateMapEntry
  ...
  spec:
    properties:
      ...
      map:
        ...
        type: string
      matcher:
        description: Immutable. A predefined matcher for particular cases, other than
          SNI selection.
        type: string
      projectRef:
