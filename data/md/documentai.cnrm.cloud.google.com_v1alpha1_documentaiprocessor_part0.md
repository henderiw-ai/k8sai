# openAPI schema part0 for documentai.cnrm.cloud.google.com.v1alpha1.DocumentAIProcessor
  ...
  spec:
    properties:
      displayName:
        ...
        type: string
      kmsKeyName:
        description: Immutable. The KMS key used for encryption/decryption in CMEK
      ...
      resourceID:
        ...
        type: string
      type:
        description: Immutable. The type of processor. For possible types see the
          [official list](https://cloud.google.com/document-ai/docs/reference/rest/v1/projects.locations/fetchProcessorTypes#google.cloud.documentai.v1.DocumentProcessorService.FetchProcessorTypes).
        type: string
    required:
    - displayName
    - location
