# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputeInstanceGroupNamedPort
  ...
  spec:
    properties:
      groupRef:
        ...
        properties:
          external:
            description: 'Allowed value: The `name` field of a `ComputeInstanceGroup`
              resource.'
            type: string
          name:
        ...
        type: object
      port:
        description: Immutable. The port number, which can be a value between 1 and
          65535.
        type: integer
      projectRef:
      ...
      resourceID:
        ...
        type: string
      zone:
        description: Immutable. The zone of the instance group.
        type: string
    required:
    - groupRef
    - port
