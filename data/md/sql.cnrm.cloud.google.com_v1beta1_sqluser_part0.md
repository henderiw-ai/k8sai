# openAPI schema part0 for sql.cnrm.cloud.google.com.v1beta1.SQLUser
...
properties:
  ...
  spec:
    properties:
      host:
        description: Immutable. The host the user can connect from. This is only supported
          for MySQL instances. Don't set this field for PostgreSQL instances. Can
      ...
      passwordPolicy:
        properties:
          ...
          enableFailedAttemptsCheck:
            description: If true, the check that will lock user after too many failed
              login attempts will be enabled.
            type: boolean
          enablePasswordVerification:
            description: If true, the user must specify the current password before
