# openAPI schema part0 for workflows.cnrm.cloud.google.com.v1alpha1.WorkflowsWorkflow
  ...
  spec:
    properties:
      ...
      projectRef:
        ...
        type: object
      region:
        description: Immutable. The region of the workflow.
        type: string
      resourceID:
  ...
  status:
    properties:
      conditions:
        ...
        type: array
      createTime:
        description: The timestamp of when the workflow was created in RFC3339 UTC
      ...
      observedGeneration:
        ...
        type: integer
      revisionId:
        description: The revision of the workflow. A new one is generated if the service
          account or source contents is changed.
        type: string
      state:
        description: State of the workflow deployment.
        type: string
      updateTime:
        description: The timestamp of when the workflow was last updated in RFC3339
