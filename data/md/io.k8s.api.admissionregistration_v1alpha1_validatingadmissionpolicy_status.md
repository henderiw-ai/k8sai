# openAPI schema status for io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicy
...
|
  ...
  properties:
    ...
    status:
      ...
      description: The status of the ValidatingAdmissionPolicy, including warnings that
        are useful to determine if the policy behaves in the expected way. Populated
