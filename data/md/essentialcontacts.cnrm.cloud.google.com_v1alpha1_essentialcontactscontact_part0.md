# openAPI schema part0 for essentialcontacts.cnrm.cloud.google.com.v1alpha1.EssentialContactsContact
...
properties:
  ...
  spec:
    properties:
      email:
        description: Immutable. The email address to send notifications to. This does
          not need to be a Google account.
        type: string
      languageTag:
        description: The preferred language for notifications, as a ISO 639-1 language
          code. See Supported languages for a list of supported languages.
        type: string
      notificationCategorySubscriptions:
        description: The categories of notifications that the contact will receive
          communications for.
        items:
          type: string
        type: array
      parent:
        description: 'Immutable. The resource to save this contact for. Format: organizations/{organization_id},
