# openAPI schema part0 for kms.cnrm.cloud.google.com.v1beta1.KMSCryptoKey
      ...
      versionTemplate:
        ...
        properties:
          algorithm:
            ...
            type: string
          protectionLevel:
            description: Immutable. The protection level to use when creating a version
              based on this template. Possible values include "SOFTWARE", "HSM", "EXTERNAL",
              "EXTERNAL_VPC". Defaults to "SOFTWARE".
            type: string
        required:
        - algorithm
        type: object
