# openAPI schema part0 for tpu.cnrm.cloud.google.com.v1alpha1.TPUNode
...
properties:
  ...
  spec:
    properties:
      acceleratorType:
        description: Immutable. The type of hardware accelerators associated with
          this node.
        type: string
      cidrBlock:
        description: |-
        ...
        type: string
      description:
        description: Immutable. The user-supplied description of the TPU. Maximum
          of 512 characters.
        type: string
      network:
        description: |-
      ...
      useServiceNetworking:
        ...
        type: boolean
      zone:
        description: Immutable. The GCP location for the TPU. If it is not provided,
