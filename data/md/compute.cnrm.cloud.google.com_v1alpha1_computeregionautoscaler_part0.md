# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputeRegionAutoscaler
      ...
      autoscalingPolicy:
        ...
        properties:
          ...
          minReplicas:
            ...
            type: integer
          mode:
            description: 'Defines operating mode for this policy. Default value: "ON"
              Possible values: ["OFF", "ONLY_UP", "ON"].'
            type: string
          scaleDownControl:
            description: |-
          ...
          scalingSchedules:
            description: Scaling schedules defined for an autoscaler. Multiple schedules
              can be set on an autoscaler and they can overlap.
            items:
              properties:
                description:
                ...
                disabled:
                  description: A boolean value that specifies if a scaling schedule
                    can influence autoscaler recommendations. If set to true, then
                    a scaling schedule has no effect.
                  type: boolean
                durationSec:
                  description: The duration of time intervals (in seconds) for which
                    this scaling schedule will be running. The minimum allowed value
                    is 300.
                  type: integer
                minRequiredReplicas:
                  description: Minimum number of VM instances that autoscaler will
                    recommend in time intervals starting according to schedule.
                  type: integer
                name:
                  type: string
                schedule:
                  description: The start timestamps of time intervals when this scaling
