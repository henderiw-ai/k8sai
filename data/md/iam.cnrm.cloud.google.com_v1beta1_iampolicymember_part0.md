# openAPI schema part0 for iam.cnrm.cloud.google.com.v1beta1.IAMPolicyMember
  ...
  spec:
    ...
    properties:
      condition:
        ...
        type: object
      member:
        description: Immutable. The IAM identity to be bound to the role. Exactly
          one of 'member' or 'memberFrom' must be used.
        type: string
      memberFrom:
        description: Immutable. The IAM identity to be bound to the role. Exactly
          one of 'member' or 'memberFrom' must be used, and only one subfield within
        ...
        properties:
          logSinkRef:
            description: The LoggingLogSink whose writer identity (i.e. its 'status.writerIdentity')
          ...
          serviceAccountRef:
            ...
            type: object
          serviceIdentityRef:
            description: The ServiceIdentity whose service account (i.e., its 'status.email')
              is to be bound to the role.
            properties:
              name:
                type: string
