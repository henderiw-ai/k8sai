# openAPI schema part0 for resourcemanager.cnrm.cloud.google.com.v1beta1.Folder
...
properties:
  ...
  spec:
    ...
    properties:
      displayName:
        description: The folder's display name. A folder's display name must be unique
