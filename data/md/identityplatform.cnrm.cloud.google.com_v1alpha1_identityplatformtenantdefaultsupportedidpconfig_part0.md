# openAPI schema part0 for identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformTenantDefaultSupportedIDPConfig
  ...
  spec:
    properties:
      ...
      projectRef:
        ...
        type: object
      resourceID:
        description: Immutable. Optional. The idpId of the resource. Used for creation
          and acquisition. When unset, the value of `metadata.name` is used as the
          default.
        type: string
      tenant:
        description: Immutable. The name of the tenant where this DefaultSupportedIdpConfig
          resource exists.
        type: string
    required:
    - clientId
