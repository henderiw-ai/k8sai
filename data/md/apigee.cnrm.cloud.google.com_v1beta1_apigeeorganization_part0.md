# openAPI schema part0 for apigee.cnrm.cloud.google.com.v1beta1.ApigeeOrganization
...
properties:
      ...
      addonsConfig:
        ...
        properties:
          ...
          monetizationConfig:
            ...
            properties:
              enabled:
                description: Flag that specifies whether the Monetization add-on is
                  enabled.
                type: boolean
            type: object
        type: object
      analyticsRegion:
        description: Immutable. Required. Primary GCP region for analytics data storage.
          For valid values, see (https://cloud.google.com/apigee/docs/api-platform/get-started/create-org).
        type: string
  ...
  status:
    properties:
      billingType:
        description: 'Output only. Billing type of the Apigee organization. See (https://cloud.google.com/apigee/pricing).
          Possible values: BILLING_TYPE_UNSPECIFIED, SUBSCRIPTION, EVALUATION'
        type: string
      caCertificate:
        description: Output only. Base64-encoded public certificate for the root CA
          of the Apigee organization. Valid only when (#RuntimeType) is `CLOUD`.
        type: string
      conditions:
        ...
        type: array
      createdAt:
        description: Output only. Time that the Apigee organization was created in
      ...
      environments:
        ...
        type: array
      expiresAt:
        description: Output only. Time that the Apigee organization is scheduled for
          deletion.
        format: int64
        type: integer
      lastModifiedAt:
      ...
      projectId:
        ...
        type: string
      state:
        description: 'Output only. State of the organization. Values other than ACTIVE
        ...
        type: string
      subscriptionType:
        description: 'Output only. DEPRECATED: This will eventually be replaced by
