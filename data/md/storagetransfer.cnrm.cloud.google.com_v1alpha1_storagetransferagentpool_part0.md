# openAPI schema part0 for storagetransfer.cnrm.cloud.google.com.v1alpha1.StorageTransferAgentPool
...
properties:
  ...
  spec:
    properties:
      bandwidthLimit:
        description: Specifies the bandwidth limit details. If this field is unspecified,
          the default value is set as 'No Limit'.
        properties:
          limitMbps:
            description: Bandwidth rate in megabytes per second, distributed across
