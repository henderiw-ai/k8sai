# openAPI schema part0 for memcache.cnrm.cloud.google.com.v1beta1.MemcacheInstance
  ...
  spec:
    properties:
      ...
      nodeCount:
        ...
        type: integer
      region:
        description: Immutable. The region of the Memcache instance. If it is not
    ...
    properties:
      ...
      memcacheNodes:
        ...
        items:
          properties:
            host:
              description: Hostname or IP address of the Memcached node used by the
                clients to connect to the Memcached server on this node.
              type: string
            nodeId:
              description: Identifier of the Memcached node. The node id does not
