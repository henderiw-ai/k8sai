# openAPI schema part0 for dataflow.cnrm.cloud.google.com.v1beta1.DataflowFlexTemplateJob
  ...
  spec:
    properties:
      ...
      enableStreamingEngine:
        description: Immutable. Indicates if the job should use the streaming engine
          feature.
        type: boolean
      ipConfiguration:
      ...
      kmsKeyNameRef:
        ...
        type: object
      launcherMachineType:
        description: The machine type to use for launching the job. The default is
          n1-standard-1.
        type: string
      machineType:
        ...
        type: string
      maxWorkers:
        description: Immutable. The maximum number of Google Compute Engine instances
          to be made available to your pipeline during execution, from 1 to 1000.
        type: integer
      networkRef:
        oneOf:
        - not:
        ...
        type: object
      numWorkers:
        description: Immutable. The initial number of Google Compute Engine instances
          for the job.
        type: integer
      parameters:
        type: object
      ...
      region:
        ...
        type: string
      sdkContainerImage:
        description: Docker registry location of container image to use for the 'worker
      ...
      serviceAccountEmailRef:
        ...
        type: object
      stagingLocation:
        description: The Cloud Storage path to use for staging files. Must be a valid
      ...
      subnetworkRef:
        ...
        type: object
      tempLocation:
        description: The Cloud Storage path to use for temporary files. Must be a
          valid Cloud Storage URL, beginning with gs://.
        type: string
      transformNameMapping:
        description: Only applicable when updating a pipeline. Map of transform name
          prefixes of the job to be replaced with the corresponding name prefixes
          of the new job.
        type: object
        x-kubernetes-preserve-unknown-fields: true
    required:
