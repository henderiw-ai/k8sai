# openAPI schema part0 for filestore.cnrm.cloud.google.com.v1alpha1.FilestoreSnapshot
...
properties:
  ...
  spec:
    properties:
      description:
        description: A description of the snapshot with 2048 characters or less. Requests
      ...
      instance:
        ...
        type: string
      location:
        description: Immutable. The name of the location of the instance. This can
  ...
  status:
    properties:
      ...
      createTime:
        ...
        type: string
      filesystemUsedBytes:
        description: The amount of bytes needed to allocate a full copy of the snapshot
          content.
        type: string
      observedGeneration:
