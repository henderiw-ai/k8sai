# openAPI schema part0 for inv.nephio.org.v1alpha1.Link
...
```yaml
description: Link is the Schema for the vlan API
properties:
  apiVersion:
  ...
  spec:
    ...
    properties:
      endpoints:
        description: Endpoints define the node + interface endpoints associated with
          this link
        items:
          properties:
            interfaceName:
