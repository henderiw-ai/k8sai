# openAPI schema part4 for dlp.cnrm.cloud.google.com.v1beta1.DLPDeidentifyTemplate
                      ...
                      properties:
                        infoTypes:
                          description: InfoTypes to apply the transformation to. An
                            empty list will cause this transformation to apply to
                            all findings that correspond to infoTypes that were requested
                            in `InspectConfig`.
                          items:
                            properties:
                              name:
