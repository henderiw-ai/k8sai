# openAPI schema part0 for cloudasset.cnrm.cloud.google.com.v1alpha1.CloudAssetOrganizationFeed
    ...
    properties:
      ...
      contentType:
        description: 'Asset content type. If not specified, no content but the asset
          name and type will be returned. Possible values: ["CONTENT_TYPE_UNSPECIFIED",
