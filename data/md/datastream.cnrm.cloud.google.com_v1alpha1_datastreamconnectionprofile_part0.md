# openAPI schema part0 for datastream.cnrm.cloud.google.com.v1alpha1.DatastreamConnectionProfile
  ...
  spec:
    properties:
      ...
      gcsProfile:
        ...
        type: object
      location:
        description: Immutable. The name of the location this connection profile is
          located in.
        type: string
      mysqlProfile:
        ...
        properties:
          hostname:
            ...
            type: string
          password:
            description: Immutable. Password for the MySQL connection.
            oneOf:
            - not:
                required:
                - valueFrom
