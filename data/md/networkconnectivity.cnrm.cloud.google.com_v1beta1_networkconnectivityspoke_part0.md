# openAPI schema part0 for networkconnectivity.cnrm.cloud.google.com.v1beta1.NetworkConnectivitySpoke
  ...
  spec:
    properties:
      ...
      linkedInterconnectAttachments:
        description: Immutable. A collection of VLAN attachment resources. These resources
        ...
        properties:
          siteToSiteDataTransfer:
            description: Immutable. A value that controls whether site-to-site data
              transfer is enabled for these resources. Note that data transfer is
  ...
  status:
    properties:
      ...
      state:
        ...
        type: string
      uniqueId:
        description: Output only. The Google-generated UUID for the spoke. This value
          is unique across all spoke resources. If a spoke is deleted and another
          with the same name is created, the new spoke is assigned a different unique_id.
        type: string
      updateTime:
