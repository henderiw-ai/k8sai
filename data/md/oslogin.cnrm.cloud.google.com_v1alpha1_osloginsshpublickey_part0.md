# openAPI schema part0 for oslogin.cnrm.cloud.google.com.v1alpha1.OSLoginSSHPublicKey
  ...
  spec:
    properties:
      expirationTimeUsec:
        ...
        type: string
      key:
        description: Immutable. Public key text in SSH format, defined by RFC4253
          section 6.6.
        type: string
      project:
        ...
        type: string
      resourceID:
        description: Immutable. Optional. The service-generated fingerprint of the
          resource. Used for acquisition only. Leave unset to create a new resource.
        type: string
      user:
        description: Immutable. The user email.
        type: string
    required:
    - key
    - user
