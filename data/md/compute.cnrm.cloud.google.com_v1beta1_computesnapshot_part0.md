# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeSnapshot
  ...
  spec:
    properties:
      ...
      sourceDiskRef:
        ...
        type: object
      storageLocations:
        description: Immutable. Cloud Storage bucket storage location of the snapshot
