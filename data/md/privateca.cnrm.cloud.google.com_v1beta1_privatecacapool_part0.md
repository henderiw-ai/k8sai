# openAPI schema part0 for privateca.cnrm.cloud.google.com.v1beta1.PrivateCACAPool
  ...
  spec:
    properties:
      issuancePolicy:
        ...
        properties:
          allowedIssuanceModes:
            ...
            type: object
          allowedKeyTypes:
            description: Optional. If any AllowedKeyType is specified, then the certificate
              request's public key must match one of the key types listed here. Otherwise,
              any key may be used.
            items:
              properties:
                ellipticCurve:
                  ...
                  properties:
                    signatureAlgorithm:
                      description: 'Optional. A signature algorithm that must be used.
                        If this is omitted, any EC-based signature algorithm will
                        be allowed. Possible values: EC_SIGNATURE_ALGORITHM_UNSPECIFIED,
          ...
          baselineValues:
            description: Optional. A set of X.509 values that will be applied to all
              ...
              conflicting values for the same properties, they will be overwritten
              by the values defined here. If a certificate request uses a CertificateTemplate
              that defines conflicting predefined_values for the same properties,
            ...
            type: object
          identityConstraints:
            description: Optional. Describes constraints on identities that may appear
              in Certificates issued through this CaPool. If this is omitted, then
          ...
          passthroughExtensions:
            description: Optional. Describes the set of X.509 extensions that may
              ...
              those extensions will be dropped. If a certificate request uses a CertificateTemplate
              with predefined_values that don't appear here, the certificate issuance
              request will fail. If this is omitted, then this CaPool will not add
              restrictions on a certificate's X.509 extensions. These constraints
              do not apply to X.509 extensions set in this CaPool's baseline_values.
            properties:
              additionalExtensions:
        ...
        properties:
          publishCaCert:
            description: Optional. When true, publishes each CertificateAuthority's
              ...
              X.509 extension in all issued Certificates. If this is false, the CA
      ...
      resourceID:
        ...
        type: string
      tier:
        description: 'Immutable. Required. Immutable. The Tier of this CaPool. Possible
          values: TIER_UNSPECIFIED, ENTERPRISE, DEVOPS'
        type: string
    required:
    - location
    - projectRef
