# openAPI schema part0 for logging.cnrm.cloud.google.com.v1beta1.LoggingLogBucket
...
properties:
  ...
  spec:
    ...
    properties:
      billingAccountRef:
        description: Immutable. The BillingAccount that this resource belongs to.
        ...
        properties:
          external:
            description: 'Allowed value: The Google Cloud resource name of a Google
              Cloud Billing Account (format: `billingAccounts/{{name}}`).'
            type: string
          name:
            description: |-
      ...
      description:
        ...
        type: string
      folderRef:
        description: Immutable. The Folder that this resource belongs to. Only one
          of [billingAccountRef, folderRef, organizationRef, projectRef] may be specified.
        oneOf:
        - not:
            required:
            - external
        ...
        properties:
          external:
            description: 'Allowed value: The Google Cloud resource name of a `Folder`
              resource (format: `folders/{{name}}`).'
            type: string
          name:
        ...
        type: object
      location:
        description: 'Immutable. The location of the resource. The supported locations
          are: global, us-central1, us-east1, us-west1, asia-east1, europe-west1.'
        type: string
      locked:
        description: Whether the bucket has been locked. The retention period on a
      ...
      organizationRef:
        description: Immutable. The Organization that this resource belongs to. Only
          one of [billingAccountRef, folderRef, organizationRef, projectRef] may be
          specified.
        oneOf:
        - not:
            required:
      ...
      retentionDays:
        description: Logs will be retained by default for this amount of time, after
          which they will automatically be deleted. The minimum retention period is
          1 day. If this value is set to zero at bucket creation time, the default
  ...
  status:
    properties:
      conditions:
        ...
        type: array
      createTime:
        description: Output only. The creation timestamp of the bucket. This is not
          set for any of the default buckets.
        format: date-time
        type: string
      lifecycleState:
        description: 'Output only. The bucket lifecycle state. Possible values: LIFECYCLE_STATE_UNSPECIFIED,
