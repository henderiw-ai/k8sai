# openAPI schema status for io.k8s.api.admissionregistration.v1.MutatingWebhook
...
```yaml
|
  description: MutatingWebhook describes an admission webhook and the resources and
