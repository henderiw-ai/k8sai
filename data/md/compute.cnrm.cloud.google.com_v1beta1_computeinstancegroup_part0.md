# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeInstanceGroup
  ...
  spec:
    properties:
      ...
      resourceID:
        ...
        type: string
      zone:
        description: Immutable. The zone that this instance group should be created
          in.
        type: string
    required:
    - zone
