# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeFirewall
  ...
  spec:
    properties:
      ...
      disabled:
        ...
        type: boolean
      enableLogging:
        description: DEPRECATED. Deprecated in favor of log_config. This field denotes
          whether to enable logging for a particular firewall rule. If logging is
