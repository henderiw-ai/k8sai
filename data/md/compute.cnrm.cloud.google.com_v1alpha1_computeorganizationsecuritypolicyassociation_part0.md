# openAPI schema part0 for compute.cnrm.cloud.google.com.v1alpha1.ComputeOrganizationSecurityPolicyAssociation
...
properties:
  ...
  spec:
    properties:
      attachmentId:
        description: Immutable. The resource that the security policy is attached
          to.
        type: string
      policyId:
