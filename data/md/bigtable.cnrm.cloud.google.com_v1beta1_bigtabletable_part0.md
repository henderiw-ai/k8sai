# openAPI schema part0 for bigtable.cnrm.cloud.google.com.v1beta1.BigtableTable
  ...
  spec:
    properties:
      changeStreamRetention:
        description: Duration to retain change stream data for the table. Set to 0
      ...
      columnFamily:
        ...
        type: array
      deletionProtection:
        description: A field to make the table protected against data loss i.e. when
          set to PROTECTED, deleting the table, the column families in the table,
          and the instance containing the table would be prohibited. If not provided,
