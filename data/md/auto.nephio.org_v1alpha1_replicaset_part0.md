# openAPI schema part0 for auto.nephio.org.v1alpha1.ReplicaSet
...
```yaml
description: ReplicaSet is the Schema for the ReplicaSet API
properties:
  apiVersion:
  ...
  spec:
    ...
    properties:
      pipeline:
        properties:
          mutators:
            description: Mutators defines a list of of KRM functions that mutate the
              templ;ate.
            items:
              properties:
                expression:
        ...
        type: object
      replicas:
        description: Number of desired replicas. This is a pointer to distinguish
          between explicit zero and not specified. Defaults to 1.
        format: int32
        type: integer
      selectors:
        description: ObjectSelector selects objects that can be served as input to
          the pipeline for parameter mutation/validation
        items:
          properties:
            apiVersion:
            ...
            name:
              ...
              type: string
            variableName:
              description: VariableName is the name of the variable that is used for
        ...
        type: array
      template:
        description: Template is the embedded KRM template
        type: object
