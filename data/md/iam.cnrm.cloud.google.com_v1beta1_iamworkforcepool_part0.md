# openAPI schema part0 for iam.cnrm.cloud.google.com.v1beta1.IAMWorkforcePool
    ...
    properties:
      ...
      organizationRef:
        description: Immutable. The Organization that this resource belongs to. Only
          one of [organizationRef] may be specified.
        oneOf:
        - not:
            required:
            - external
      ...
      sessionDuration:
        description: How long the Google Cloud access tokens, console sign-in sessions,
          and gcloud sign-in sessions from this pool are valid. Must be greater than
          15 minutes (900s) and less than 12 hours (43200s). If `session_duration`
          is not configured, minted credentials will have a default duration of one
          hour (3600s).
        type: string
    required:
    - location
