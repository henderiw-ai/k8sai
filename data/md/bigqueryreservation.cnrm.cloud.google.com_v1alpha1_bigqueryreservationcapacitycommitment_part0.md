# openAPI schema part0 for bigqueryreservation.cnrm.cloud.google.com.v1alpha1.BigQueryReservationCapacityCommitment
  ...
  spec:
    properties:
      ...
      enforceSingleAdminProjectPerOrg:
        description: Immutable. If true, fail the request if another project in the
      ...
      projectRef:
        ...
        type: object
      renewalPlan:
        description: The plan this capacity commitment is converted to after commitmentEndTime
          passes. Once the plan is changed, committed period is extended according
          to commitment plan. Only applicable some commitment plans.
        type: string
      resourceID:
        description: Immutable. Optional. The capacityCommitmentId of the resource.
