# openAPI schema part0 for compute.cnrm.cloud.google.com.v1beta1.ComputeRouterPeer
  ...
  spec:
    properties:
      ...
      enable:
        ...
        type: boolean
      enableIpv6:
        description: Enable IPv6 traffic over BGP Peer. If not specified, it is disabled
          by default.
        type: boolean
      ipAddress:
        description: |-
