# openAPI schema part0 for iam.cnrm.cloud.google.com.v1beta1.IAMAuditConfig
  ...
  spec:
    ...
    properties:
          ...
          properties:
            exemptedMembers:
              description: Identities that do not cause logging for this type of permission.
                The format is the same as that for 'members' in IAMPolicy/IAMPolicyMember.
              items:
                type: string
              type: array
            logType:
      ...
      resourceRef:
        ...
        type: object
      service:
        description: 'Immutable. Required. The service for which to enable Data Access
          audit logs. The special value ''allServices'' covers all services. Note
          that if there are audit configs covering both ''allServices'' and a specific
          service, then the union of the two audit configs is used for that service:
          the ''logTypes'' specified in each ''auditLogConfig'' are enabled, and the
